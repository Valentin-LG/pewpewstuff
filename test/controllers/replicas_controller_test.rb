...
class ReplicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create replica" do
    assert_difference("Replica.count") do
      post replicas_url, params: { replica: { brand: @replica.brand, category: @replica.category, name: @replica.name, price: @replica.price, reference: @replica.reference } }, as: :json
    end
  ...
  test "should update replica" do
    patch replica_url(@replica), params: { replica: { brand: @replica.brand, category: @replica.category, name: @replica.name, price: @replica.price, reference: @replica.reference } }, as: :json
    assert_response :success
  end
