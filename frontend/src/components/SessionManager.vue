<template>
  <div class="container">
    ...
    <div class="sm-card">
      ...
      <div v-else>
        <h3>Sign Up!</h3>
        <form class="sign-up-form" @submit="onSignUp">
          <input v-model="signUpEmail" class="sign-up-form-email" placeholder="Email" type="email"/>
          <br/>
          <input
          ...
          />
          <br/>
          <input class="sign-up-form-submit" type="submit" value="Sign up"/>
        </form>
        <hr/>
        <br/>
        <h3>Login!</h3>
        <form class="login-form" @submit="onLogin">
          <input v-model="loginEmail" class="login-form-email" placeholder="Email" type="text"/>
          <br/>
          <input v-model="loginPassword" class="login-form-password" placeholder="Password" type="password"/>
          <br/>
